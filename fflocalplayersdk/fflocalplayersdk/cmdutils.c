...
static void prepare_app_arguments(int *argc_ptr, char ***argv_ptr)
{
    ...
    if (win32_argv_utf8) {
		av_log(NULL, AV_LOG_FATAL, "prepare_app_arguments: win32_argv_utf8\n");
        *argc_ptr = win32_argc;
	...
	av_log(NULL, AV_LOG_FATAL, "prepare_app_arguments: CommandLineToArgvW, &win32_argc=%d\n", win32_argc);
	if (win32_argc <= 0 || !argv_w) {
		av_log(NULL, AV_LOG_FATAL, "prepare_app_arguments: win32_argc <= 0 || !argv_w\n");
		return;
	}
	...
	av_log(NULL, AV_LOG_FATAL, "prepare_app_arguments: win32_argc = %d\n", win32_argc);
                   ...
                   void (*parse_arg_function)(void *, const char*))
{
	...
	av_log(NULL, AV_LOG_FATAL, "arg:after prepare_app_arguments argc=%d\n", argc);
